...
### 1.1.1 波粒二象性（wave-particle duality）
...
### 1.4.1 两能级系统在辐射能量密度环境下（爱因斯坦系数）

考虑温度为 \(T\) 的黑体辐射场中，体积 \(1\,\mathrm{m^3}\) 内有 \(N\) 个相同两能级粒子：
...
- 吸收与受激辐射系数相等  
- 自发辐射系数随频率三次方增长：频率越高越容易自发辐射（越“容易发光”）
